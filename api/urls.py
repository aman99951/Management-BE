...
from .views import EmployeeViewSet, MeetingViewSet, TaskViewSet, fathom_config_view, fathom_sync_view, fathom_webhook_view, fathom_webhook_register_view, dashboard_stats, auth_session, auth_logout, google_auth, oauth_sso, verify_sso, fathom_recording_detail, fathom_oauth_url, fathom_oauth_callback, extract_tasks_all, generate_ai_tasks, google_calendar_status, google_calendar_auth_url, google_calendar_oauth_callback, google_calendar_create_meet, google_calendar_list_events, google_calendar_sync, google_calendar_disconnect, ScheduledMeetingViewSet, notifications_list, notifications_mark_read, BacklogItemViewSet, backlog_scan, dismiss_suggestion, generation_status_view, process_pending_jobs
...
urlpatterns = [
    ...
    path('tasks/generation-status/', generation_status_view),
    path('tasks/process-pending/', process_pending_jobs),
    path('', include(router.urls)),
    path('fathom/config/', fathom_config_view),
    path('fathom/sync/', fathom_sync_view),
    path('fathom/webhook/', fathom_webhook_view),
    path('fathom/webhook/register/', fathom_webhook_register_view),
