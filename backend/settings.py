...
CSRF_TRUSTED_ORIGINS = os.getenv('CSRF_TRUSTED_ORIGINS', 'https://management-be-eight.vercel.app,https://management-f-e.vercel.app,http://127.0.0.1:5173,http://localhost:5173,http://127.0.0.1:8000').split(',')
